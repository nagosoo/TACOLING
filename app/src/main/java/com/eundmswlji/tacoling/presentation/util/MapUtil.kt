package com.eundmswlji.tacoling.presentation.util
...
object MapUtil {
    ...
    fun getUserCurrentLocation(
        context: Context,
        onSuccessListener: (suspend (Double, Double) -> (Unit))?
    ) {
    ...
    suspend fun calculateMeterFromCoordinates(
        lat1: Double,
        lon1: Double,
        lat2: Double,
        lon2: Double
